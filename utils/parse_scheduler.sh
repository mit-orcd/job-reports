...
# Usage:
# ./parse_scheduler.sh <input_dir> <output_dir> [log_file]
# ./parse_scheduler.sh /orcd/data/orcd/022/util_viz/data /orcd/data/orcd/022/util_viz/data/parsed_monthly /orcd/data/orcd/022/util_viz/data/parsed_monthly/processed_files.log
